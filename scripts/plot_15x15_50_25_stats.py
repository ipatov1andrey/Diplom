...
# Новый путь к файлу
file_path = 'examples/generated/15x15_50_25_stats.txt'
...
plt.title('Разброс процента двойных мостов (15x15, 50 островов, 25%)')
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.tight_layout()
plt.savefig('double_bridge_percent_boxplot.png', dpi=300)
plt.show() 