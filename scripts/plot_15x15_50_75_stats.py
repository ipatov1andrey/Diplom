...
file_path = 'examples/generated/15x15_50_75_stats.txt'
...
plt.title('Разброс процента двойных мостов (15x15, 50 островов, 75%)')
plt.xticks([1], ['75%'])
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.tight_layout()
plt.savefig('double_bridge_percent_boxplot_75.png', dpi=300)
plt.show() 